...
The hidden_units argument provides a list of ints
  - where each int corresponds to a hidden layer and indicates the number of nodes in it
...
Overfitting is a potential hazard for NNs
  - look at the gap between loss on training data and loss on validation data to help judge if your model is starting to overfit. If the gap starts to grow, that is usually a sure sign of overfitting.
